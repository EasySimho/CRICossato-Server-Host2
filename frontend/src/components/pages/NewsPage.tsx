  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        ...
        // Estrai le categorie uniche dalle notizie
        const uniqueCategories = Array.from(new Set(mappedNews.map(item => item.category)));
